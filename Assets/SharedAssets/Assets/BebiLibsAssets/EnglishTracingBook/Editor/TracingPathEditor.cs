...
public class PathEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.Separator();
        if (PrefabUtility.GetCorrespondingObjectFromSource(tracingPath.gameObject) != null)
        ...
        tracingPath.firstNumber = EditorGUILayout.ObjectField("First Number", tracingPath.firstNumber, typeof(Transform), true) as Transform;
        if (tracingPath.fillMethod != TracingPath.FillMethod.Point)
            tracingPath.secondNumber = EditorGUILayout.ObjectField("Second Number", tracingPath.secondNumber, typeof(Transform), true) as Transform;
