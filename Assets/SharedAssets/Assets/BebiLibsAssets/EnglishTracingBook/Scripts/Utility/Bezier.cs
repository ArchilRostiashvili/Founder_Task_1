    ...
    public class Bezier
    {
        ...
        */
        public void SamplePoints(List<Vector3> sourcePoints, float minSqrDistance, float maxSqrDistance, float scale)
        {
            ...
            this.Interpolate(new List<Vector3>(samplePoints), scale);
        }
        ...
        */
        public List<Vector3> GetDrawingPoints2()
        {
            ...
            for (int curveIndex = 0; curveIndex < this.curveCount; curveIndex++)
            {
                List<Vector3> bezierCurveDrawingPoints = this.FindDrawingPoints(curveIndex);
        ...
        */
        ...
        {
            Vector3 left = this.CalculateBezierPoint(curveIndex, t0);
            Vector3 right = this.CalculateBezierPoint(curveIndex, t1);
