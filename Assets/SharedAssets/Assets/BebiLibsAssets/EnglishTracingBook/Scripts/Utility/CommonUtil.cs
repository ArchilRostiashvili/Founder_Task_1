...
namespace IndieStudio.EnglishTracingBook.Utility
{
    public class CommonUtil
    {
        ...
        //-0.1244x^3+0.1574x^2+0.3677x+0.5252
        public static float Cubic(float x, float a, float b, float c, float d)
        {
        ...
        public static GameObject SaveAsPrefab(string localPath, GameObject gameObject, bool select)
        {
            ...
            UnityEngine.Object prefab = PrefabUtility.SaveAsPrefabAsset(gameObject, localPath);
