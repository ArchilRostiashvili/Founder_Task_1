...
namespace I2.Loc
{
    ...
    public partial class LocalizeInspector : Editor
    {
        ...
        SerializedProperty mProp_mTerm, mProp_mTermSecondary,
                            ...
                            mProp_CallbackEvent, mProp_CallBackEndEvent;
        ...
        void OnEnable()
        {
            ...
            mProp_CallBackEndEvent = serializedObject.FindProperty("OnLocalizationEnds");
        ...
        public override void OnInspectorGUI()
        {
            ...
            else
            {
                ...
                EditorGUILayout.PropertyField(mProp_CallBackEndEvent, new GUIContent("On Localize Callback End"));
