...
namespace I2.Loc
{
    ...
    public partial class Localize : MonoBehaviour
    {
        ...
        public UnityEvent<string> OnLocalizationEnds = new UnityEvent<string>();             // This allows scripts to modify the translations :  e.g. "Player {0} wins"  ->  "Player Red wins"	
        ...
        public void OnLocalize(bool Force = false)
        {
            ...
            this.OnLocalizationEnds?.Invoke(MainTranslation);
            //Debug.Log(MainTranslation);
        }
